        ...
        >
          <div class="col-md-9 ftco-animate pb-5">
            <p class="breadcrumbs">
              <span class="mr-2"
                ><a href="main.do"
                  ><spring:message code = "detail.a.smallhome" /><i class="ion-ios-arrow-forward"></i></a
              ></span>
                ...
                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a
                      ...
                      aria-expanded="true"
                      ><spring:message code = "detail.navlink.pillsmanufacturer" /></a
                    >
                  </li>
                  <li class="nav-item">
                    <a
                      ...
                      aria-expanded="true"
                      ><spring:message code = "detail.navlink.pillsreview" /></a
                    >
                  </li>
                </ul>
              </div>
