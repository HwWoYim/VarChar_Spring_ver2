...
<body>
    <div id="wrapper">
        ...
        <div id="messagesWrap">
            <div id="messages">
                   <!--  <p class="chatText youchat"><span class="chatTextMsg">안녕하세요</span></p>
                    <p class="chatText mychat"><span class="chatTextMsg">네 반가워요</span></p>
                    <p class="chatText mychat"><span class="chatTextMsg">상담 신청</span></p>
                     <p class="chatText youchat"><span class="chatTextMsg">안녕하세요</span></p>
                      <p class="chatText youchat"><span class="chatTextMsg">안녕하세요</span></p>
                      <p class="chatText mychat"><span class="chatTextMsg">상담 신청</span></p>
                      <p class="chatText mychat"><span class="chatTextMsg">상담 신청</span></p> -->
        ...
        <div id="wrapperBottom">
           ...
           <!--  <button class="buttons buttonStyle" type="button" onclick="javascripe:clearText();">clear</button> -->
        </div>
    </div>
    <script>
    let webSocket
